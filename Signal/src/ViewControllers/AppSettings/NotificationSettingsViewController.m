...
- (void)updateTableContents
{
    ...
    OWSTableSection *messageAndCall = [OWSTableSection new];
    messageAndCall.headerTitle = NSLocalizedString(@"MESSAGES_AND_CALLS", @"");
    [contents addSection:messageAndCall];
    ...
    backgroundSection.footerTitle
        = NSLocalizedString(@"", @"table section footer");
