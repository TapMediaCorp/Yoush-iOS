...
- (void)updateTableContents
{
    ...
    OWSTableSection *appAccess = [OWSTableSection new];
    appAccess.headerTitle = NSLocalizedString(@"COMMUNICATION", @"");
    [contents addSection:appAccess];
    ...
    OWSTableSection *community = [OWSTableSection new];
    community.headerTitle = NSLocalizedString(@"APP_ACCESS", @"");
    [contents addSection:community];
             ...
             [[NSAttributedString alloc]
              ...
              attributes:@{
                  NSLinkAttributeName : [NSURL
                                         URLWithString:@"https://support.tapofthink.com/hc/articles/360007059792"],
                  NSFontAttributeName : UIFont.ows_dynamicTypeCaption1Font
              }]];
    ...
    OWSTableSection *sealedSender = [OWSTableSection new];
    sealedSender.headerTitle = NSLocalizedString(@"SEALED_SENDER", @"");
    [contents addSection:sealedSender];
    ...
    [unidentifiedDeliveryFooterText
        appendAttributedString:[[NSAttributedString alloc]
                                   initWithString:CommonStrings.learnMore
                                       attributes:@{
                                           NSLinkAttributeName :
                                               [NSURL URLWithString:@"https://tapofthink.com/blog/sealed-sender/"],
                                           NSFontAttributeName : UIFont.ows_dynamicTypeCaption1Font
                                       }]];
