...
extension ConversationViewController: MessageRequestDelegate {
    ...
    func leaveAndSoftDeleteThread() {
        ...
        let completion = {
            ...
            SignalApp.shared().mainTabBarVC?.closeSelectedConversation(animated: true)
        }
    ...
    func messageRequestViewDidTapLearnMore() {
        ...
        guard let url = URL(string: "https://support.tapofthink.com/hc/articles/360007459591") else {
