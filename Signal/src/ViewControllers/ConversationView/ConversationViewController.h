...
@property (weak, nonatomic) FLPinnedMessageListView *normalPinMessageView;
@property (weak, nonatomic) FLPinnedMessageListView *expandPinnedMessageView;
