...
- (NSArray*)pinnedMessage {
    NSArray *pinnedMessages = [self.viewState.viewItems filteredArrayUsingPredicate:[NSPredicate predicateWithBlock:^BOOL(id  <ConversationViewItem> evaluatedObject, NSDictionary<NSString *,id> * _Nullable bindings) {
        TSInfoMessage *msg = (id)evaluatedObject.interaction;
        if ([msg isKindOfClass:TSInfoMessage.class] &&
            msg.infoMessageUserInfo[InfoMessageUserInfoPinMessageAction]) {
            return true;
        }
        return false;
    }]];
//    //Sort by most recent
//    pinnedMessages = [pinnedMessages sortedArrayUsingComparator:^NSComparisonResult(id <ConversationViewItem>  _Nonnull obj1, id <ConversationViewItem>  _Nonnull obj2) {
//        TSInfoMessage *msg1 = (id)obj1.interaction;
//        TSInfoMessage *msg2 = (id)obj2.interaction;
//        return [@(msg2.updatedAtTimestamp) compare:@(msg1.updatedAtTimestamp)];
//    }];
