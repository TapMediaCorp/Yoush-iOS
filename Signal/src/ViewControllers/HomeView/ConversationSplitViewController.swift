...
//
//                    let detailVC: UIViewController = {
//                        guard !self.isCollapsed else { return vc }
//
//                        self.detailNavController.viewControllers = [vc]
//                        return self.detailNavController
//                    }()
//
//                    if animated {
//                        self.showDetailViewController(detailVC, sender: self)
//                    } else {
//                        UIView.performWithoutAnimation { self.showDetailViewController(detailVC, sender: self) }
//                    }
//                }
//            }
//
...
@objc extension ConversationListViewController {
    var mainTabBarVC: FLTabbarViewController? {
        return SignalApp.shared().mainTabBarVC
//        return splitViewController as? FLTabbarViewController
    }
}
//
