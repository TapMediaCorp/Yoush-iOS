...
public class NewGroupConfirmViewController: OWSViewController {
                                                     ...
                                                     canCancel: false) { modalActivityIndicator in
                                                        firstly {
                                                            ...
                                                            modalActivityIndicator.dismiss {
                                                                ...
                                                                NewGroupConfirmViewController.showCreateErrorUI(error: error) { action in
    ...
    public class func showCreateErrorUI(error: Error, buttonAction: ActionSheetAction.Handler? = nil) {
        AssertIsOnMainThread()
        ...
        if error.isNetworkFailureOrTimeout {
            OWSActionSheets.showActionSheet(title: NSLocalizedString("ERROR_NETWORK_FAILURE",
                                            ...
                                            message: NSLocalizedString("NEW_GROUP_CREATION_FAILED_DUE_TO_NETWORK",
                                                                     comment: "Error indicating that a new group could not be created due to network connectivity problems."), buttonAction: buttonAction)
            return
        }
        ...
        OWSActionSheets.showActionSheet(title: NSLocalizedString("NEW_GROUP_CREATION_FAILED",
                                                                 comment: "Error indicating that a new group could not be created."), buttonAction: buttonAction)
    }
