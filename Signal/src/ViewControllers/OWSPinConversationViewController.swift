...
@objc(OWSPinConversationViewController)
public class PinConversationViewController: OWSViewController {
    ...
    @objc
    init(title: String, explanation: String, actionText: String, completionHandler: @escaping (String) -> Void) {
    ...
    @objc func cancelPressed() {
        ...
        dismiss(animated: true) { self.completionHandler("") }
    }
...
//                print("TRUNCATEDPINCODE: ", truncatedPinCode)
...
extension PinConversationViewController: UIViewControllerTransitioningDelegate {
...
extension PinConversationViewController: UITextFieldDelegate {
