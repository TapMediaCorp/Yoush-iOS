...
@objc(OWSPinSetupConvConfirmViewController)
public class PinSetupConvConfirmViewController: OWSViewController {
    ...
    private let completionHandler: (PinSetupConvConfirmViewController, Error?) -> Void
    ...
    init(
        ...
        completionHandler: @escaping (PinSetupConvConfirmViewController, Error?) -> Void
    ) {
    ...
    @objc
    class func creatingRegistrationLock(completionHandler: @escaping (PinSetupConvConfirmViewController, Error?) -> Void) -> PinSetupConvConfirmViewController {
        return .init(mode: .creating, enableRegistrationLock: true, completionHandler: completionHandler)
    }

    @objc
    class func creating(completionHandler: @escaping (PinSetupConvConfirmViewController, Error?) -> Void) -> PinSetupConvConfirmViewController {
        return .init(mode: .creating, completionHandler: completionHandler)
    }

    @objc
    class func changing(completionHandler: @escaping (PinSetupConvConfirmViewController, Error?) -> Void) -> PinSetupConvConfirmViewController {
...
//            )
    ...
    @objc func backTwo(_ completion: FLVoidBlock? = nil) {
        navigationController?.setNavigationBarHidden(false, animated: false)
        //  let viewControllers: [UIViewController] = self.navigationController!.viewControllers as [UIViewController]
        if let rootVC = navigationController?.viewControllers.first {
            navigationController?.popToViewController(rootVC, animated: true, completion: {
    ...
    private func tryToContinue() {
        ...
        case .creating, .changing, .recreating:
            let confirmingVC = PinSetupConvConfirmViewController(
...
extension PinSetupConvConfirmViewController: UITextFieldDelegate {
...
extension PinSetupConvConfirmViewController {
...
class PinConvProgressView: UIView {
    ...
    required init(loadingText: String) {
        ...
        label.font = UIFont(name: Fonts.Roboto_Regular, size: 17)
        label.textColor = UIColor(rgbHex: 0x707070)
        label.textAlignment = .center
