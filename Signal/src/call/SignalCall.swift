...
public class SignalCall: NSObject, SignalCallNotificationInfo {
    ...
    @objc
    public var threadForCall: TSThread? {
    ...
    public internal(set) var thread: TSContactThread!

    public let sentAtTimestamp: UInt64

    //User for jitsi call
    public internal(set) var audioOnly = true
    public internal(set) var room = ""
    public internal(set) var subject = ""
    public internal(set) var groupThread:TSGroupThread!
//    public var infoMessage:TSInfoMessage!
//    public var infoMessageWasSaved = false
    
    public var isGroupCall: Bool {
        return false
    }
    
    public var currentThread:TSThread? {
    ...
    public var callerName:String {
        ...
        return Environment.shared.contactsManager.displayName(for: remoteAddress)
    }
