...
@objc public class CommonStrings: NSObject {
    ...
    @objc
    static public let hideConversationAction = NSLocalizedString("CONVERSATION_ACTION", comment: "Label for the archive button for conversations list view")

    @objc
    static public let backButton = NSLocalizedString("BACK_BUTTON", comment: "return to the previous screen")

    @objc
    static public let continueButton = NSLocalizedString("BUTTON_NEXT", comment: "Label for 'continue' button.")
    ...
    @objc
    static public let unhideConversationAction = NSLocalizedString("UNCONVERSATION_ACTION", comment: "Label for the unarchive button for conversations list view")
...
public class NotificationStrings: NSObject {
    ...
    @objc
    static public let receiverBusyCallBody = NSLocalizedString("END_CALL_RESPONDER_IS_BUSY", comment: "notification body")
