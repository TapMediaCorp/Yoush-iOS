...
//    self.nameLabel.textColor = Theme.primaryTextColor;
    self.nameLabel.textColor = Theme.youshGoldColor;
...
//    [self updateAvatar];
    ...
    ConversationColorName colorName = [TSThread stableColorNameForNewConversationWithString:contact.fullName];
    
    OWSContactAvatarBuilder *avatarBuilder = [[OWSContactAvatarBuilder alloc] initWithNonSignalNameComponents:nameComponents colorSeed:colorName diameter:self.avatarSize];
