...
//            let backgroundImage = UIImage(color: UIColor(rgbHex: 0x202020))

            let backgroundImage = UIImage(named: "6-navbar-background")!.resizableImage(withCapInsets: UIEdgeInsets.zero, resizingMode: .stretch)
