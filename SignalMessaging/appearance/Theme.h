...
@property (class, readonly, nonatomic) UIColor *blueTextColor;
...
@property (class, readonly, nonatomic) UIColor *youshGoldColor;
...
@property (class, readonly, nonatomic) UIColor *grayBorderIconColor;
