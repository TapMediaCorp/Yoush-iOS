...
//    UIColor *color = UIColor.ows_blueColorNew;
    UIColor *color = Theme.youshGoldColor;
    ...
    if (self.contactInitials.length == 0) {
        ...
        if (self.diameter > kStandardAvatarSize) {
            icon = [UIImage imageNamed:@"contact-avatar-1024-new"];
        } else {
            icon = [UIImage imageNamed:@"contact-avatar-1024-new"];
        }
        ...
        CGFloat scaling = (self.diameter / (CGFloat)kStandardAvatarSize) * (50 / assetWidthPixels);
                                                      ...
                                                      diameter:(CGFloat)diameter
{
    ...
    UIColor *backgroundColor = UIColor.ows_accentBlueColor;
