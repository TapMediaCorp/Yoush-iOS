                                     ...
                                     diameter:(NSUInteger)diameter
{
    ...
    UIColor *backgroundColor =
        UIColor.ows_blueColorNew;
#else
//    UIColor *backgroundColor = [OWSConversationColor ows_blueColorNew];
    UIColor *backgroundColor = Theme.youshGoldColor;
#endif
...
+ (nullable UIImage *)groupAvatarImageWithBackgroundColor:(UIColor *)backgroundColor diameter:(NSUInteger)diameter
{
    ...
    CGFloat scaling = diameter * 0.011f;
