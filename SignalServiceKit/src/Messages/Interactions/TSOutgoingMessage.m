...
- (instancetype)initOutgoingMessageWithBuilder:(TSOutgoingMessageBuilder *)outgoingMessageBuilder
{
    ...
    if ([thread isKindOfClass:TSGroupThread.class]) {
        ...
        // If the metadata is pin message
        if (groupMetaMessage == TSGroupMetaMessagePinMessage) {
            _groupMetaMessage = groupMetaMessage;
        }else {
...
- (BOOL)shouldBeSaved
{
    //Does not save message contains customMetaData
                                                ...
                                                transaction:(SDSAnyReadTransaction *)transaction
{
    ...
    switch (self.groupMetaMessage) {
        ...
        case TSGroupMetaMessageNew:
            ...
            break;
        case TSGroupMetaMessagePinMessage:
            groupMessageType = SSKProtoGroupContextTypePinMessage;
            break;
        default:
